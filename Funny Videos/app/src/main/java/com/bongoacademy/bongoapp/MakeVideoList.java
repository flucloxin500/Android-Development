...
public class MakeVideoList {
	...
	public static void createMyAlbums(){
		...
		//==========================================================================
		addVideoItem("zC3UbTf4qrM", "Afghan Jalebi (Ya Baba) FULL VIDEO Song", "Teri har cheez jannat ae -hasna vi jannt ae");
		addVideoItem("zOMQ42aFlQ8", "Allah di kasam tu mainu enna pyara ho gaya", "Teri har cheez jannat ae -hasna vi jannt ae");
		addVideoItem("zu5s_T4yOv8", "Allah di kasam tu mainu enna pyara ho gaya", "Teri har cheez jannat ae -hasna vi jannt ae");
		addVideoItem("xE9FBL7jUGA", "Allah di kasam tu mainu enna pyara ho gaya", "Teri har cheez jannat ae -hasna vi jannt ae");
		createPlayList("Amazing Songs", R.drawable.category_1);
		//==========================================================================
